...
@csrf_exempt # For simplicity in this example, but consider CSRF protection in production
def my_endpoint(request):
    if request.method == 'GET':
        ...
        try:
            ...
            # Process new_item (e.g., save to database)
            response_data = {'message': f'Item "{new_item}" created successfully'}
